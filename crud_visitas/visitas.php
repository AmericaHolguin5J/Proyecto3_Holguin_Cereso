                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos</h1>
                                <form action="insertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="nombre" placeholder="INGRESA NOMBRE">
                                    <input type="text" class="form-control mb-3" name="apellido" placeholder="INGRESA APELLIDO">
                                    <input type="text" class="form-control mb-3" name="hora" placeholder="INGRESA HORA">
                                    <input type="text" class="form-control mb-3" name="telefono" placeholder="INGRESA TELEFONO">
                                    <input type="text" class="form-control mb-3" name="parentesco" placeholder="INGRESA PARENTESCO">
                                    <input type="text" class="form-control mb-3" name="asunto" placeholder="INGRESA ASUNTO">
                            ...
                            <table class="table" >
                                <thead class="table-success table-striped" >
                                    <tr>
                                        ...
                                        <th>INGRESA PARENTESCO</th>
                                        <th>INGRESA ASUNTO</th>
                                        <th></th>
                                        <th></th>
                                    </tr>
                                </thead>
